...
export const EstablishmentDeleteDialog = (props: IEstablishmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mupalApp.establishment.delete.question">
        <Translate contentKey="mupalApp.establishment.delete.question" interpolate={{ id: establishmentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-establishment" color="danger" onClick={confirmDelete}>
