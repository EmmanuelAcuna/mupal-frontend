...
public class ClientResourceIT {
    ...
    private static final String DEFAULT_LOG_URL = "AAAAAAAAAA";
    private static final String UPDATED_LOG_URL = "BBBBBBBBBB";
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getContactId()).isEqualTo(DEFAULT_CONTACT_ID);
        assertThat(testClient.getLogUrl()).isEqualTo(DEFAULT_LOG_URL);
    }
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].logUrl").value(hasItem(DEFAULT_LOG_URL)));
    }
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.logUrl").value(DEFAULT_LOG_URL));
    }
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getContactId()).isEqualTo(UPDATED_CONTACT_ID);
        assertThat(testClient.getLogUrl()).isEqualTo(UPDATED_LOG_URL);
    }
