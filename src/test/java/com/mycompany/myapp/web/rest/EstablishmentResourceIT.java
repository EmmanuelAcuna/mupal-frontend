...
public class EstablishmentResourceIT {
    ...
    private static final Long DEFAULT_PAYD_DATE = 1L;
    private static final Long UPDATED_PAYD_DATE = 2L;
    ...
    public void createEstablishment() throws Exception {
        ...
        assertThat(testEstablishment.getPaydDate()).isEqualTo(DEFAULT_PAYD_DATE);
        assertThat(testEstablishment.getLat()).isEqualTo(DEFAULT_LAT);
        assertThat(testEstablishment.getLng()).isEqualTo(DEFAULT_LNG);
    }
    ...
    public void getAllEstablishments() throws Exception {
        ...
        restEstablishmentMockMvc.perform(get("/api/establishments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].paydDate").value(hasItem(DEFAULT_PAYD_DATE.intValue())))
    ...
    public void getEstablishment() throws Exception {
        ...
        restEstablishmentMockMvc.perform(get("/api/establishments/{id}", establishment.getId()))
            ...
            .andExpect(jsonPath("$.paydDate").value(DEFAULT_PAYD_DATE.intValue()))
    ...
    public void updateEstablishment() throws Exception {
        ...
        assertThat(testEstablishment.getPaydDate()).isEqualTo(UPDATED_PAYD_DATE);
        assertThat(testEstablishment.getLat()).isEqualTo(UPDATED_LAT);
        assertThat(testEstablishment.getLng()).isEqualTo(UPDATED_LNG);
    }
